...
import { FileText, Shield, ArrowRight, Bot, Users, Sparkles, ExternalLink } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-indigo-900 via-purple-900 to-stone-950 flex items-center justify-center p-4">
      <div className="w-full max-w-6xl">
        ...
        <div className="text-center mt-12 text-gray-400 text-sm">
          <p className="mb-2">© 2025 Spam-sama.1984. All rights reserved.</p>
